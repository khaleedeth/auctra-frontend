    ...
    <div className="min-h-screen bg-auction-bg">
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        ...
        <button
          ...
          className="text-auction-muted text-sm hover:text-auction-text transition-colors mb-6 flex items-center gap-2"
        >
          ← Back to Auctions
        </button>
        ...
        {/* Winner Banner */}
        {isWinner && (
          <div className="bg-auction-accent/10 border border-auction-accent/30 px-6 py-4 mb-6 animate-fade-in">
            <p className="text-auction-accent font-semibold text-lg">
        ...
        {ended && !isWinner && (
          <div className="bg-auction-surface border border-auction-border px-6 py-4 mb-6">
            <p className="text-auction-text-dim">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="card p-6">
              <div className="flex items-start justify-between mb-3">
                ...
                <span className={`text-xs px-3 py-1 font-mono uppercase tracking-wider ml-4 shrink-0 ${
              ...
              <p className="text-auction-muted leading-relaxed">
                {auction.description}
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="card p-6">
                ...
                <p className="font-mono text-4xl text-auction-accent font-medium">
                  ${auction.currentPrice.toLocaleString()}
                </p>
              ...
              <div className="card p-6">
                ...
                {ended && (
                  <p className="text-auction-muted text-lg">Auction closed</p>
                )}
              </div>
            </div>
            ...
            <div className="card p-6 flex items-center gap-4">
              <div className="w-10 h-10 bg-auction-accent/10 border border-auction-accent/20 flex items-center justify-center text-auction-accent font-display text-xl">
  ...
  <div className="card p-6">
    ...
    <div className="flex gap-2 mb-3">
      {[50, 100, 200, 500].map((increment) => (
        <button
          ...
          className="flex-1 py-2 text-sm font-mono border border-auction-border text-auction-text-dim hover:border-auction-accent hover:text-auction-accent transition-all duration-200"
        >
          +{increment}
        </button>
      ))}
    ...
    <div className="flex gap-3">
      ...
      <button
        onClick={placeBid}
        disabled={bidLoading}
        className="btn-primary px-8 disabled:opacity-50 disabled:cursor-not-allowed shrink-0"
      >
                ...
                {bidHistory.map((b, i) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-7 h-7 bg-auction-surface border border-auction-border flex items-center justify-center text-auction-accent text-xs font-display">
